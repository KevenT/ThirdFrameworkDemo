...
public class SampleApplicationLike extends DefaultApplicationLike {
    ...
    public void onCreate() {
        ...
        // 当使用右侧的Gradle的Tasks中的package下的assembleReleaseChannels生成渠道包的时候这样获取。
...
//            Bugly.setAppChannel(getApplication(), channel);
        ...
        // bugly的渠道
        String BUGLY_CHANNEL = BuildConfig.FLAVOR;
        if (BUGLY_CHANNEL!=null){
            channel = BUGLY_CHANNEL;
        }
        Bugly.setAppChannel(getApplication(), channel);
...
//        Bugly.init(getApplication(), "e0b1ba785f", true);
        Bugly.init(getApplication(), "2a5521a740", true);
    }
